...
func UpdateQuorumBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.QuorumController, target string, payload *app.UpdateQuorumRequest) (http.ResponseWriter, *app.Message) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	u := &url.URL{
		Path: fmt.Sprintf("/accounts/%v/quorum", target),
	}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateQuorumInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.QuorumController, target string, payload *app.UpdateQuorumRequest) (http.ResponseWriter, *app.Message) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func UpdateQuorumOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.QuorumController, target string, payload *app.UpdateQuorumRequest) (http.ResponseWriter, *app.Message) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}

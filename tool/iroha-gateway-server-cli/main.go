...
import (
	...
	"github.com/soramitsu/iroha-gateway/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Iroha-Gateway Server-cli",
		Short: `CLI client for the Iroha-Gateway Server service`,
	}
	...
	c.UserAgent = "Iroha-Gateway Server-cli/0"

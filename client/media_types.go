...
// AnAccount media type (default view)
//
// Identifier: application/vnd.an.account+json; view=default
...
// Validate validates the AnAccount media type instance.
func (mt *AnAccount) Validate() (err error) {
	if mt.Message == "" {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`response`, "message"))
	}
...
// DecodeAnAccount decodes the AnAccount instance encoded in resp body.
func (c *Client) DecodeAnAccount(resp *http.Response) (*AnAccount, error) {
	var decoded AnAccount
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// AnCurrency media type (default view)
//
// Identifier: application/vnd.an.currency+json; view=default
type AnCurrency struct {
	// response code
	Code     int         `form:"code" json:"code" xml:"code"`
...
// Validate validates the AnCurrency media type instance.
func (mt *AnCurrency) Validate() (err error) {
	if mt.Message == "" {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`response`, "message"))
	}
...
// DecodeAnCurrency decodes the AnCurrency instance encoded in resp body.
func (c *Client) DecodeAnCurrency(resp *http.Response) (*AnCurrency, error) {
	var decoded AnCurrency
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
